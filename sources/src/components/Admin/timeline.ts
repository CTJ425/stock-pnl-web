...
export const ACTION_SCOPE: Record<string, string> = {
  'generate-all':
    '持股∪觀察∪TOP20 成交量（含 ETF）台股：三大法人 T86 / 融資融券 / 借券 + 日 K + 估值 + 月營收 + 獲利能力；' +
    '並回傳 reportComplete（持股與 TOP20 雙範圍 soft 就緒）。16:00 起與 T86 同窗，非 15:00',
  /*
  ...
  */
  ...
  'sync-top-tickers':
    'TWSE MI_INDEX20（mi-stock20 成交量前 20，含 ETF，官方證券代號），寫入 meta/top_tickers.json；' +
