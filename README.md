...
- **年度收益**：台股 / 美股分區年度已實現損益，各欄位皆可排序，年度列可展開個股明細（含當年只買進、尚未賣出者）。金額採「含費 / 未含費」雙行顯示，並提供「賣出成本」欄，使每列成立 `已實現損益 = 賣出收入 − 賣出成本`；另有「投入成本」欄顯示當年買進的現金流出（含當年尚未賣出的部位，與賣出三欄不是同一批股票，不可互相加減）。
