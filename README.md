...
### 0.6.21（2026-08-04）— 補齊季度獲利能力的歷史

- **「持股獲利能力」搬到「個股分析」**。它講的是公司不是市場，而且個股分析本來就只列台股，
  正好對上「只有台股個股有這份資料」。
- **一次補齊過去三年的季度數字**。原本每晚抓的官方端點只給「最新一季」，
  要湊滿得等三年；現在改由公開資訊觀測站的季報彙總回補，每晚補兩季，一個晚上就補完。
  保留季數也從 8 季（兩年）提高到 **12 季（三年）**，看得到一輪完整的景氣循環。
- 金融業沒有「毛利率」這個概念，那一欄會顯示「—」，其餘三項照常。
