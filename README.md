...
> **目前版本：0.9.55-dev.1**（版本號顯示於畫面左下角徽章）
...
- **總體經濟**：分為三個子分頁。
  - **台股**：加權指數當日分時走勢與 60 日 K 線、市場成交量與三大法人買賣金額。
  ...
  - **國際指數**（0.9.54 起）：日經 225、KOSPI、KOSDAQ、道瓊、S&P 500、那斯達克、費城半導體、羅素 2000，依日本／韓國／美國三區分組並標示當下時段（盤中／午休／已收盤）。盤中每 60 秒更新，且**只向當下有開盤的市場要報價**；全部收盤時不發任何請求。美股時段以 `America/New_York` 判斷，不寫死時差，日光節約自動生效。
