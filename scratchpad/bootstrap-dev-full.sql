-- =========================================================
-- FULL bootstrap for NEW dev: korq9tvdz0jd7yblr72p.ivan.lab
-- Generated 2026-08-07 — includes tables, storage bucket, crons, admin RPC
-- CRON_SECRET is embedded in cron.job commands (same value must be set on Edge Function secrets)
-- =========================================================
...
--      korq9tvdz0jd7yblr72p.ivan.lab：Supabase 專案 ref（Project Settings → General → Reference ID）
...
--    The cron in §6c is unschedule + schedule, and the entire rerun will fill in korq9tvdz0jd7yblr72p.ivan.lab
