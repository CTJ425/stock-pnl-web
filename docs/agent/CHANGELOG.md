...
### 0.7.7-dev.3（2026-08-11）— 探針命中後當天就不再探該來源
...
### 0.7.7-dev.2（2026-08-11）— 移除個股買賣超長條圖；修正「探針命中但資料不更新」
...
### 0.7.7-dev.1（2026-08-11）— 個股籌碼的三大法人也改用同一套矩陣
