...
### 0.7.1-dev.3（2026-08-10）— 三大法人：放大走勢、預設展開最新日

#### 功能摘要

- 🎨 波折圖放大（約 100×36）；說明文字 **「連 N 日買超／賣超」放在圖上方**。
- 🎨 恢復 **＋／− 展開** 與 **全部展開／全部收起**；**預設只展開最新交易日**（收合時只顯示合計列）。
- 前端 only；不必 redeploy Edge。

---

### 0.7.1-dev.2（2026-08-10）— 總經分頁；三大法人表改買進／賣出欄

#### 功能摘要

- 🎨 **總體經濟**拆二次分頁：**台股**｜**美國經濟**（預設台股）。
- 🎨 **三大法人買賣超**主表改為 **日期 × 單位 × 買進／賣出／買賣超**（不再用展開列）。
- 前端 only；不必 redeploy Edge。
