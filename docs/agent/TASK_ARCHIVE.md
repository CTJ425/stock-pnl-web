...
- **Follow-up (2026-09-09 10:29:57 CST) — data-table contrast**: the four levers left every table row on one tone, so a long table read as a single block. Fixed inside Carbon by giving the table four separable surfaces instead of one, plus a text hierarchy inside the cell.
